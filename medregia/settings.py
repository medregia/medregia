"""
Django settings for medregia project.
...
SECRET_KEY = 'django-insecure-+%s=!cc!l0g2^ble+&wt^olk8056n99bnihjbms^bwgvh-1l-v'
...
MIDDLEWARE = [
    ...
    'invclc.middleware.NoCacheMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'authentication.context_processors.all_notifications',
...
WSGI_APPLICATION = 'medregia.wsgi.application'
