# Generated by Django 4.2.3 on 2024-05-07 17:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('store_type', models.CharField(blank=True, choices=[('retailer', 'Retailer'), ('manufacturer', 'Manufacturer'), ('pharmacy', 'Pharmacy'), ('medical', 'Medical'), ('others', 'Others')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('MedicalShopName', models.CharField(blank=True, max_length=100, null=True)),
                ('ProprietaryName', models.CharField(blank=True, max_length=100, null=True)),
                ('ProprietaryNumber', models.CharField(blank=True, max_length=100, null=True)),
                ('ProprietaryContact', models.CharField(blank=True, max_length=100, null=True)),
                ('DrugLiceneseNumber2', models.CharField(blank=True, max_length=100, null=True)),
                ('DrugLiceneseNumber1', models.CharField(blank=True, max_length=100, null=True)),
                ...
                ('RegisteredNumber', models.CharField(blank=True, max_length=100, null=True)),
